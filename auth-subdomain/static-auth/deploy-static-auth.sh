...
# GearGrab Static Auth Subdomain Deployment Script
# Deploys to login.geargrab.co

set -e

echo "🔐 GearGrab Static Auth Subdomain Deployment"
echo "============================================"
...
echo "📋 Building and deploying static auth service..."
...
echo "✅ Static auth service deployed to Cloud Run"
...
echo ""
echo "✅ Static auth subdomain deployment completed successfully!"
echo ""
...
echo ""
echo "✅ GearGrab Static Auth is now live! 🎉"
