<script lang="ts">
  ...
  $: {
    ...
    hasChanges = formData.title !== '' || formData.description !== '';
  }
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (data.success) {
        ...
        goto(`/dashboard/listings/${listingId}`);
      } else {
    ...
    {:else}
      ...
      <div class="flex items-center justify-between mb-8">
        <div class="flex items-center space-x-4">
          <button
            on:click={() => goto(`/dashboard/listings/${listingId}`)}
          ...
          <div>
            ...
            <p class="mt-2 text-gray-600">Update your listing details</p>
          </div>
        </div>
        
        {#if hasChanges}
          <span class="text-sm text-orange-600 bg-orange-100 px-3 py-1 rounded-full" data-cy="unsaved-changes">
            Unsaved changes
          </span>
        {/if}
      </div>
      ...
      <!-- Form -->
      <form on:submit|preventDefault={handleSubmit} class="space-y-8" data-cy="edit-listing-form">
        <!-- Basic Information -->
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., Canon, GearGrab, Nike"
                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                data-cy="brand-input"
              />
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
          ...
          <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center" data-cy="image-upload-area">
            ...
            <p class="text-gray-600 mb-2">Update photos of your item</p>
