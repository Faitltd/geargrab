...
<div class="space-y-8">
  ...
  <ScrollAnimated animation="fade-up" delay={200}>
    <SequentialAnimator baseDelay={300} incrementDelay={150} className="grid grid-cols-1 md:grid-cols-3 gap-6">
  ...
  <ScrollAnimated animation="fade-up" delay={400}>
    <div class="bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 shadow-lg">
      ...
      <div class="p-6">
        <SequentialAnimator baseDelay={200} incrementDelay={100} className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button
          ...
          <a href="/browse" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-xl transition-all duration-300 inline-flex items-center justify-center shadow-lg hover:transform hover:scale-105">
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
            </svg>
            Browse Gear
          </a>
          <a href="/messages" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-4 rounded-xl transition-all duration-300 inline-flex items-center justify-center shadow-lg hover:transform hover:scale-105">
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
