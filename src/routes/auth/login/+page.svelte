<script lang="ts">
  ...
  async function handleAppleSignIn() {
    ...
    try {
      ...
      notificationsStore.success('Successfully logged in with Apple!');
      goto(redirectTo);
    } catch (error: any) {
  ...
  async function handleMicrosoftSignIn() {
    ...
    try {
      ...
      notificationsStore.success('Successfully logged in with Microsoft!');
      goto(redirectTo);
    } catch (error: any) {
  ...
  async function handleYahooSignIn() {
    ...
    try {
      ...
      notificationsStore.success('Successfully logged in with Yahoo!');
      goto(redirectTo);
    } catch (error: any) {
