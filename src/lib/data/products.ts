...
export const products: Product[] = [
  // Camping Gear
  {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1478131143081-80f7f84ca84d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80'
    ],
  ...
  // Mountain Bike
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80'
    ],
  ...
  // 4. Inline Skates - Rollerblades
  {
    ...
    images: ['https://images.unsplash.com/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80'],
    ...
    owner: { id: 'owner-004', name: 'Maria Garcia', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.6, reviewCount: 15 },
  ...
  // 5. Electric Scooter
  {
    ...
    owner: { id: 'owner-005', name: 'James Park', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.8, reviewCount: 27 },
  ...
  // 6. Road Bike
  {
    ...
    images: ['https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80'],
    ...
    owner: { id: 'owner-006', name: 'Rachel Thompson', avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.9, reviewCount: 22 },
  ...
  // 7. Hiking Backpack
  {
    ...
    images: ['https://images.unsplash.com/photo-1551632811-561732d1e306?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80'],
    ...
    owner: { id: 'owner-007', name: 'Chris Martinez', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.7, reviewCount: 19 },
  ...
  // 8. Ski Equipment Set
  {
    ...
    images: ['https://images.unsplash.com/photo-1551524164-6cf2ac2d7d6c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80'],
    ...
    owner: { id: 'owner-008', name: 'Michael Snow', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.8, reviewCount: 25 },
  ...
  // 9. Climbing Gear Set
  {
    ...
    images: ['https://images.unsplash.com/photo-1522163182402-834f871fd851?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80'],
    ...
    owner: { id: 'owner-009', name: 'Alex Climber', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.9, reviewCount: 33 },
  ...
  // 10. Water Sports - Kayak
  {
    ...
    images: ['https://images.unsplash.com/photo-1544551763-46a013bb70d5?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80'],
    ...
    owner: { id: 'owner-010', name: 'River Guide Co', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.7, reviewCount: 41 },
  ...
  // 11. Electric Bike
  {
    ...
    owner: { id: 'owner-011', name: 'Urban Cycles', avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.8, reviewCount: 29 },
  ...
  // 12. Snowboard Set
  {
    ...
    owner: { id: 'owner-012', name: 'Mountain Sports', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.6, reviewCount: 38 },
  ...
  // 13. Camping Sleeping Bag
  {
    ...
    images: ['https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80'],
    ...
    owner: { id: 'owner-013', name: 'Alpine Gear Co', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.9, reviewCount: 45 },
  ...
  // 14. Skateboard
  {
    ...
    owner: { id: 'owner-014', name: 'Skate Shop Pro', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.5, reviewCount: 28 },
  ...
  // 15. Paddleboard
  {
    ...
    owner: { id: 'owner-015', name: 'River Adventures', avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.8, reviewCount: 52 },
  ...
  // 16. Camping Stove
  {
    ...
    securityDeposit: 75,
    location: { city: 'Aspen', state: 'CO', zipCode: '81611' },
    images: ['https://images.unsplash.com/photo-1504851149312-7a075b496cc7?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80'],
    ...
    owner: { id: 'owner-016', name: 'Mountain Chef', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.9, reviewCount: 28 },
  ...
  // 17. Fishing Gear Set
  {
    ...
    owner: { id: 'owner-017', name: 'River Guide Pro', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.7, reviewCount: 35 },
  ...
  // 18. Photography Gear
  {
    ...
    images: ['https://images.unsplash.com/photo-1502920917128-1aa500764cbd?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80'],
    ...
    owner: { id: 'owner-018', name: 'Adventure Photographer', avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.9, reviewCount: 42 },
  ...
  // 19. Winter Sports - Cross Country Skis
  {
    ...
    owner: { id: 'owner-019', name: 'Nordic Ski Shop', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.6, reviewCount: 31 },
  ...
  // 20. Snowboard
  {
    ...
    owner: { id: 'owner-020', name: 'Powder Rider', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.8, reviewCount: 24 },
  ...
  // 21. Kayak
  {
    ...
    specifications: { 'Length': '12 feet', 'Width': '33 inches', 'Weight': '68 lbs', 'Capacity': '375 lbs', 'Material': 'Polyethylene' },
    owner: { id: 'owner-021', name: 'River Explorer', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.7, reviewCount: 38 },
  ...
  // 22. Electric Scooter
  {
    ...
    owner: { id: 'owner-022', name: 'Urban Rider', avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.9, reviewCount: 45 },
  ...
  // 23. Rock Climbing Gear Set
  {
    ...
    owner: { id: 'owner-023', name: 'Vertical Adventures', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.9, reviewCount: 67 },
  ...
  // 24. Camping Cookware Set
  {
    ...
    owner: { id: 'owner-024', name: 'Camp Kitchen Pro', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.7, reviewCount: 33 },
  ...
  // 25. Fat Tire Bike
  {
    ...
    owner: { id: 'owner-025', name: 'Fat Bike Fanatic', avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.6, reviewCount: 29 },
  ...
  // 26. Hiking Backpack
  {
    ...
    owner: { id: 'owner-026', name: 'Trail Master', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.8, reviewCount: 41 },
  ...
  // 27. Drone for Outdoor Photography
  {
    ...
    owner: { id: 'owner-027', name: 'Aerial Photographer', avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.9, reviewCount: 56 },
  ...
  // 28. Surfboard
  {
    ...
    owner: { id: 'owner-028', name: 'Water Sports Pro', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.7, reviewCount: 34 },
  ...
  // 29. Electric Bike
  {
    ...
    owner: { id: 'owner-029', name: 'E-Bike Explorer', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.8, reviewCount: 39 },
  ...
  // 30. Camping Hammock Setup
  {
    ...
    owner: { id: 'owner-030', name: 'Hammock Camper', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80', rating: 4.9, reviewCount: 27 },
...
export const featuredGear = [
  { id: 'camp-001', title: 'Premium 4-Person Tent', price: '$35/day', location: 'Denver, CO', image: 'https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80' },
  { id: 'emob-001', title: 'OneWheel Pint X Electric Board', price: '$65/day', location: 'Boulder, CO', image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80' },
  { id: 'bike-001', title: 'Trek X-Caliber 8 Mountain Bike', price: '$45/day', location: 'Vail, CO', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80' },
  { id: 'skate-001', title: 'Rollerblade Inline Skates', price: '$25/day', location: 'Fort Collins, CO', image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80' }
];
...
export const categories = [
  ...
  { id: 'biking', name: 'Biking', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80' },
  { id: 'electric-mobility', name: 'E-Mobility', image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80' },
  { id: 'skating', name: 'Skating', image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80' },
  { id: 'hiking', name: 'Hiking', image: 'https://images.unsplash.com/photo-1551632811-561732d1e306?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80' },
