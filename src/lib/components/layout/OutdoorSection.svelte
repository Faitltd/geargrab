<script lang="ts">
  ...
  export let blurIntensity = 'backdrop-blur-sm';
  export let padding = 'py-16';
  export let fadeTop = true;
  export let fadeBottom = true;
  export let contentBg = 'bg-white bg-opacity-90';
