    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      <div>
        ...
        <p class="text-gray-300 text-sm">
          The peer-to-peer marketplace for outdoor gear rentals. Find camping, hiking, skiing, and other outdoor equipment from local owners.
        </p>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-2 text-gray-300 text-sm">
          ...
          <li><a href="/safety-trust" class="hover:text-white">Safety & Trust</a></li>
      ...
      <div>
        ...
        <ul class="space-y-2 text-gray-300 text-sm">
          ...
          <li><a href="/cancellation-policy" class="hover:text-white">Cancellation Policy</a></li>
          <li><a href="/report-issue" class="hover:text-white">Report an Issue</a></li>
        </ul>
      </div>
