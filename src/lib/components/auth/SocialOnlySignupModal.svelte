<script>
  ...
  async function handleSocialAuth(provider) {
    ...
    try {
      console.log(`🚀 Starting signup with ${provider}...`);
  ...
  >
    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative">
      ...
      <div class="text-center mb-8">
        <h2 id="signup-modal-title" class="text-2xl font-bold text-gray-900 mb-2">
          Create your account
        </h2>
        <p class="text-gray-600">
          Join GearGrab to start renting and listing gear
        </p>
      </div>
      ...
      <div class="space-y-4">
        ...
        >
          ...
          {loading ? 'Creating account...' : 'Sign up with Apple'}
        </button>

        <!-- Facebook Auth - ACTIVE & FUNCTIONAL - Updated 2025-06-26 -->
        <button
        ...
        >
          ...
          {loading ? 'Creating account...' : 'Sign up with Facebook'}
        </button>
